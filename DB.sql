...
-- -----------------------------------------------------
-- Table `ecommerce_db`.`piattaforma`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `ecommerce_db`.`dettagli_ordine`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `ecommerce_db`.`trade_in`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce_db`.`trade_in` ;

CREATE TABLE IF NOT EXISTS `ecommerce_db`.`trade_in` (
  `id_trade_in` INT NOT NULL AUTO_INCREMENT,
  `descrizione_bene` TEXT NOT NULL,
  `valore_stimato` DECIMAL(10,2) NULL DEFAULT NULL,
  `stato` VARCHAR(50) NOT NULL DEFAULT 'In valutazione',
  `id_utente` INT NOT NULL,
  PRIMARY KEY (`id_trade_in`),
  INDEX `id_utente` (`id_utente` ASC) VISIBLE,
  CONSTRAINT `trade_in_ibfk_1`
    FOREIGN KEY (`id_utente`)
    REFERENCES `ecommerce_db`.`utente` (`id_utente`)
    ON DELETE CASCADE)
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `ecommerce_db`.`immagine` (
  ...
  `id_trade_in` INT NULL DEFAULT NULL,
  PRIMARY KEY (`id_immagine`),
  INDEX `id_prodotto` (`id_prodotto` ASC) VISIBLE,
  INDEX `id_trade_in` (`id_trade_in` ASC) VISIBLE,
  CONSTRAINT `immagine_ibfk_1`
    FOREIGN KEY (`id_prodotto`)
    REFERENCES `ecommerce_db`.`prodotto` (`id_prodotto`)
    ON DELETE CASCADE,
  CONSTRAINT `immagine_ibfk_2`
    FOREIGN KEY (`id_trade_in`)
    REFERENCES `ecommerce_db`.`trade_in` (`id_trade_in`)
    ON DELETE CASCADE)
ENGINE = InnoDB
AUTO_INCREMENT = 13
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `ecommerce_db`.`recensione`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ecommerce_db`.`recensione` ;

CREATE TABLE IF NOT EXISTS `ecommerce_db`.`recensione` (
  `id_recensione` INT NOT NULL AUTO_INCREMENT,
  `voto` INT NOT NULL,
  `commento` TEXT NULL DEFAULT NULL,
  `data_pubblicazione` DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
  `id_utente` INT NOT NULL,
  `id_prodotto` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `ecommerce_db`.`utente_admin`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `ecommerce_db`.`utente_registrato`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `ecommerce_db`.`voce_carrello`
-- -----------------------------------------------------
